  ...
  return (
    <footer className="bg-secondary text-white pt-12 pb-6 px-0">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-10 px-4 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center md:w-1/3 mt-8 md:mt-0">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/thedogandcollar" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                {/* ...facebook svg... */}
              ...
              <a href="https://www.instagram.com/thedogandcollar_salon/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg className="w-7 h-7 hover:text-primary transition" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@thedogandcollar?lang=en" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                <svg className="w-7 h-7 hover:text-primary transition" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M21.5 8.3c-1.2 0-2.3-.4-3.2-1.1V15c0 3.3-2.7 6-6 6s-6-2.7-6-6 2.7-6 6-6c.2 0 .5 0 .7.1v2.1c-.2 0-.5-.1-.7-.1-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4V3.5h2c.1 1.5 1.3 2.7 2.8 2.8v2z"/>
                </svg>
              </a>
            </div>
            <button
      ...
      <div className="text-center mt-10 text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} The Dog and Collar Ltd. All rights reserved.
      </div>
    </footer>
  );
};
